...
public class CoverageTools {
	...
	// args = new String[] { "calculateScoreHistogram", "-cov",
	// "src/test/resources/testScoreHist/testScoreHist.codoc", "-bed",
	// "src/test/resources/testScoreHist/testScoreHist.bed", "-binSize",
	// "5", "-o", "src/test/resources/testScoreHist/testScoreHist.csv" };

	// args = new String[] { "calculateScoreHistogram", "-cov",
	// "c:/data/genomicAmbiguity/ecK12/eck12_MG1655_ecoli-chr-GENOME.ISS.wig.codoc",
	// "-bed",
	// "c:/data/hfq-pd/ref/eck12_MG1655_ecoli-annotations-ORF.bed",
	// "-binSize", "5", "-o",
	// "c:/data/genomicAmbiguity/ecK12/HIST-eck12_MG1655_ecoli-annotations-ORF.bed-ISS.csv",
...
//		"c:/data/genomicAmbiguity/human/Low-Avg.ISS-ORFs.bed", "-scale", "100" };
	...
	// new File("src/test/resources/testScoreHist/testScoreHist.bed"),
	// System.out, 2, 1.0f).toCSV() );
	// System.exit(0);
	...
	try {
	    ...
	    if (subcommand.equalsIgnoreCase("calculateScoreHistogram")) {
		options = new Options();
