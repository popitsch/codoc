...
//				System.err.println("chr: " + decomit.getPosition().getChromosome() + " vs " + chr);
//			if ( decomit.getPosition().get1Position() != pos )
//				System.err.println("pos: " + decomit.getPosition().get1Position() + " vs " + pos);
//			if ( Math.round(hit.getInterpolatedCoverage()) != cov)
//				System.err.println("pos: " + Math.round(hit.getInterpolatedCoverage()) + " vs " + cov);
//			System.out.println("POS "+ decomit.getPosition().toString1based() + "\t" + hit.getInterpolatedCoverage() + "\t" + hit + "\t" + hit.getInterval().getUri());
//		}
